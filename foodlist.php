...
<head>
  <title> Explora | COMIDITAS UWU </title>
</head>
...
<body>
      ...
      <div class="collapse navbar-collapse " id="myNavbar">
        ...
        ?>
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="foodlist.php"><span class="glyphicon glyphicon-cutlery"></span> Zona de Comida </a></li>
            <li><a href="cart.php"><span class="glyphicon glyphicon-shopping-cart"></span> CARTA (<?php
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Registrase <span class="caret"></span> </a>
              <ul class="dropdown-menu">
                <li> <a href="customersignup.php"> Registrase Cliente</a></li>
                <li> <a href="managersignup.php"> Registrase ADMIN</a></li>
                <li> <a href="#"> Registrase ADMIN</a></li>
              </ul>
            </li>
  ...
  <div class="jumbotron">
    <div class="container text-center">
      <h1>¡BIENVENIDO A COMIDITAS UWU!</h1>
    </div>
  </div>
  ...
  <div class="container" style="width:95%;">
    ...
    ?>
        <div class="col-md-3">
          ...
          <form method="post" action="cart.php?action=add&id=<?php echo $row["id_consumible"]; ?>">
            <div class="mypanel" align="center" ;>
              <img src="<?php echo $row["foto_path"]; ?>" class="img-responsive">
              <h4 class="text-dark"><?php echo $row["nombre"]; ?></h4>
              <h5 class="text-info"><?php echo $row["descripcion"]; ?></h5>
              <h5 class="text-danger">S/ <?php echo $row["precio"]; ?></h5>
              ...
              <input type="hidden" name="hidden_RID" value="<?php echo $row["id_consumible"]; ?>">
    ...
    <div class="jumbotron">
      <center>
        <label style="margin-left: 5px;color: red;">
          <h1>¡Ups! No hay comida disponible.</h1>
        </label>
        <p>Aún puedes conseguir más COMIDA!</p>
      </center>
