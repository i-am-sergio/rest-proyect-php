      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"> <a href="managerlogin.php">PANEL DE CONTROL ADMIN</a></li>
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		<a href="myrestaurant.php" class="list-group-item active">Agregar nuevo Proveedor</a>
    		<a href="view_food_items.php" class="list-group-item ">Ver artículos de comida</a>
    		<a href="add_food_items.php" class="list-group-item ">Agregar artículos de comida</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> AGREGAR NUEVO PROVEEDOR</h3>

          
          <div class="form-group">
            <input type="text" class="form-control" id="id" name="id" placeholder="ID de proveedor" required="">
          </div>
          
          <div class="form-group">
            <input type="text" class="form-control" id="name" name="name" placeholder="Nombre de nuevo proveedor" required="">
          </div>

          <div class="form-group">
          <button type="submit" id="submit" name="submit" class="btn btn-primary pull-right"> AGREGAR PROVEEDOR </button>    
      </div>
        </form>
