<html>
<head>
    <title> Registro de invitados | COMIDITAS UWU </title>
  </head>
   ...
   <p>Comience creando su cuenta</p>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            <label for="fechaNaci"><span class="text-danger" style="margin-right: 5px;">*</span> Fecha Nacimiento: </label>
            <div class="input-group">
              <input class="form-control" id="fechaNaci" type="text" name="fechaNaci" placeholder="Fecha Nacimiento" required="">
              <span class="input-group-btn">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            <label for="direccion"><span class="text-danger" style="margin-right: 5px;">*</span> Dirección: </label>
            <div class="input-group">
       ...
       <label style="margin-left: 5px;"><a href="customerlogin.php">Ya tienes una cuenta? Incia Sesión.</a></label>
